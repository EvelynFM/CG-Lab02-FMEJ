...
int main()
{
	...
	*/
	...
	glm::mat4 modeloreja(1.0);
	glm::mat4 modelojo(1.0);
	glm::mat4 modelnariz(1.0);
	glm::mat4 modelbrazoi(1.0);
	glm::mat4 modelbrazod(1.0);
	glm::mat4 modelpiernai(1.0);
	glm::mat4 modelpiernad(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Limpiar la ventana
		//E1
		glClearColor(0.96f, 0.96f, 0.86f, 1.0f);//Color de fondo
		//E2
		//glClearColor(0.58f, 0.95f, 0.96f, 1.0f);//Color de fondo
		...
		//--------------------- Grua (E1) ---------------------
		//Se configura un fondo beige
	
		//para reiniciar la matriz de modelo con valor de la matriz identidad
		model = glm::mat4(1.0);
		
		//AQUÍ SE DIBUJA LA BASE, SOPORTE, LAS 4 LLANTAS
		//base
		modelaux2 = model;
		...
		color = glm::vec3(0.984f, 0.290f, 0.118f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.984f, 0.8f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::scale(model, glm::vec3(1.5f, 1.1f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//articulación 1
		model = glm::translate(model, glm::vec3(0.0f, 6.0f, -4.0f));//centro
		...
		//articulación 4
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		//rotación alrededor de la articulación que une con la canasta
		...
		//--------------------- Robot (E2) ---------------------
		//Se configura un fondo verde cian
		//Cuerpo
		model = glm::mat4(1.0);
		...
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.2f, 0.1f, 2.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		model = modelaux;
		//Cuello		
		model = glm::translate(model, glm::vec3(0.0f, 3.75f, 0.0f));//centro
		modelaux = model;
		//agregar color
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		modelbrazoi = model;
		//articulación 1
		model = glm::translate(model, glm::vec3(-1.2f, -0.3f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, -1.0f));
		//agregar color
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		modelpiernai = model;
		//articulación 1
		model = glm::translate(model, glm::vec3(-1.45f, -3.75f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(-1.0f, 0.0f, 0.0f));
		//agregar color
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//Cabeza
		modelcabeza = model;
		model = glm::translate(model, glm::vec3(0.0f, 2.85f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.8f, 2.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();
		...
		//Ojo izquierdo
		modelojo = model;
		model = glm::translate(model, glm::vec3(1.0f, 0.15f, 1.3f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.9f, 1.0f, 1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		//Pupila verde
		model = glm::translate(model, glm::vec3(0.08f, -0.05f, 0.6f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Nariz
		modelnariz = model;
		model = glm::translate(model, glm::vec3(0.0f, -0.3f, 2.2f));
		model = glm::scale(model, glm::vec3(0.55f, 0.35f, 0.45f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(1.0f, 0.0f, -1.0f));
