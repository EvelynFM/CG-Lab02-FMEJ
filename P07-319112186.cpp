...
int main()
{
	...
	//Declaración de primer luz puntual - blanca
	pointLights[0] = PointLight(1.0f, 1.0f, 1.0f,
		1.0f, 1.0f, //radiacion primer valor, segundo intensisdad del color
		0.0f, 5.5f, -20.0f,
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//--Luz
		//spotLights[3].SetPos(glm::vec3(mainWindow.getarticulacion4(), 0.0f, 0.0f));
		//--

		//Ejercicio 1:Luz con el carro
		...
		//--Luz
		spotLights[2].SetPos(glm::vec3(mainWindow.getarticulacion3(), 5.0f, 0.0f));
		//--
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Lampara
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 4.0f, -20.0));
