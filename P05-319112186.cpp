...
int main()
{
	...
	// Cuerpo
	Carro_cuerpo = Model();
	Carro_cuerpo.LoadModel("Models/Carro_P5/cuerpo.obj");
	//Cofre
	Carro_cofre = Model();
	Carro_cofre.LoadModel("Models/Carro_P5/cofre.obj");
	//Llanta Trasera Dererecha
	Carro_LlantaTD = Model();
	Carro_LlantaTD.LoadModel("Models/Carro_P5/LlantaTD.obj");
	//Llanta Trasera Izquierda
	Carro_LlantaTI = Model();
	Carro_LlantaTI.LoadModel("Models/Carro_P5/LlantaTI.obj");
	//Llanta Delantera Derecha
	Carro_LlantaDD = Model();
	Carro_LlantaDD.LoadModel("Models/Carro_P5/LlantaDD.obj");
	//Llanta Delantera Izquierda
	Carro_LlantaDI = Model();
	Carro_LlantaDI.LoadModel("Models/Carro_P5/LlantaDI.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.7f, 0.7f, 0.7f); //piso de color gris
		model = glm::mat4(1.0);
